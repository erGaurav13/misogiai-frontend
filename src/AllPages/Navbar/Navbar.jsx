...
import { FaHome, FaPlus, FaChartBar, FaSignOutAlt } from 'react-icons/fa'; // Importing icons
import { Link } from 'react-router-dom'; 
import img from "../../img/logo.png"
const Navbar = () => {
  return (<>
 
 <Box bg="#884ebe" p={1.5} width="100%" position="fixed" top="0" left="0" zIndex="1000">
  ...
  <Button color="black" variant="solid">
    <FaPlus color="black" /> Create
  </Button>
</Link>
            <Button colorScheme="teal" variant="ghost" m={2}>
              <FaChartBar color="black" /> Analytics
            </Button>
          </HStack>
        </Flex>
        ...
        {/* Right Side */}
        <Flex align="center">
          <Text color="white" mr={4}>Username</Text>
          <HStack>
